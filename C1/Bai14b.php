...
<body>
    ...
    <form action="Bai14b.php" method="post">
        <table align="center">
            <tr>
                <td><input type="text" name="name" value="" style="width:380px; height: 30px"
                        placeholder="Your name or Email"></td>
            </tr>
            <tr>
                <td><input type="text" name="phone" value="" style="width:380px; height: 30px"
            ...
            <tr>
                <td align="center">
                    <input class="submit-button" type="submit" value="Write to File">
                </td>
            </tr>
        </table>
