...
<body>
    ...
    <form action="Bai21.php" method="post">
        <table align="center">
            <tr>
                <td><input type="text" name="name" value="<?php echo $name; ?>" style="width:390px; height: 30px"
                        placeholder="Your name or Email"></td>
            </tr>
            <tr>
                <td><input type="text" name="phone" value="<?php echo $phone; ?>" style="width:390px; height: 30px"
            ...
            <tr>
                <td align="center">
                    <input class="submit-button" type="submit" value="Ghi vào file JSON">
                </td>
            </tr>
        </table>
